...
st.title("How to build a Process Behavior Chart")
...
with st.sidebar:
    ...
    st.markdown(
        """
        This project is part of a larger effort to increase the understanding and use of Process Behavior Charts (PBCs) in manufacturing specifically and business in general. 
        """)
